...
REM  ONE-MODEL version (qwen2.5:7b, ~2 h). Same output folder as run_waw_repro.bat, so running that one later adds the other 3 models without redoing 7b.
